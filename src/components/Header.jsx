      ...
      <div class="iq-navbar-custom">
        <nav class="navbar navbar-expand-lg navbar-light p-0">
          <div class="iq-navbar-logo d-flex justify-content-between">
            <a href="/home">
              <img src="./src/assets/images/logo.png" class="img-fluid" alt="" />
              <span>SocialV</span>
            </a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  ms-auto navbar-list">
              ...
              <li class="nav-item dropdown">
                <a href="#" class="dropdown-toggle" id="group-drop" data-bs-toggle="dropdown" aria-haspopup="true"
                  aria-expanded="false"><i class="ri-group-line"></i></a>
                  ...
                  <div class="card shadow-none m-0">
                    ...
                    <div class="card-body p-0">
                      <div class="iq-friend-request">
                        <div class="iq-sub-card iq-sub-card-big d-flex align-items-center justify-content-between">
                          <div class="d-flex align-items-center">
                            <img class="avatar-40 rounded" src="./src/assets/images/user/01.jpg" alt="" />
                            <div class="ms-3">
                      ...
                      <div class="iq-friend-request">
                        <div class="iq-sub-card iq-sub-card-big d-flex align-items-center justify-content-between">
                          <div class="d-flex align-items-center">
                            <img class="avatar-40 rounded" src="./src/assets/images/user/02.jpg" alt="" />
                            <div class="ms-3">
                      ...
                      <div class="iq-friend-request">
                        <div class="iq-sub-card iq-sub-card-big d-flex align-items-center justify-content-between">
                          <div class="d-flex align-items-center">
                            <img class="avatar-40 rounded" src="./src/assets/images/user/03.jpg" alt="" />
                            <div class=" ms-3">
                      ...
                      <div class="iq-friend-request">
                        <div class="iq-sub-card iq-sub-card-big d-flex align-items-center justify-content-between">
                          <div class="d-flex align-items-center">
                            <img class="avatar-40 rounded" src="./src/assets/images/user/04.jpg" alt="" />
                            <div class="ms-3">
                  ...
                  <div class="card shadow-none m-0">
                    ...
                    <div class="card-body p-0 ">
                      ...
                      <a href="#" class="iq-sub-card">
                        <div class="d-flex align-items-center">
                          <div class="">
                            <img class="avatar-40 rounded" src="./src/assets/images/user/05.jpg" alt="" />
                          </div>
                          <div class="ms-3">
              ...
              {user ? (
                <li class="nav-item dropdown">
                  <a href="#" class="   d-flex align-items-center dropdown-toggle" id="drop-down-arrow"
                    ...
                    <img src="./src/assets/images/user/1.jpg" class="img-fluid rounded-circle me-3" alt="user" />
                    <div class="caption">
                      <h6 class="mb-0 line-height">{user.fullname}</h6>
                    </div>
                  </a>
                  <div class="sub-drop dropdown-menu caption-menu" aria-labelledby="drop-down-arrow">
                    <div class="card shadow-none m-0">
                      <div class="card-header  bg-primary">
                        <div class="header-title">
                          <h5 class="mb-0 text-white">Hello {user.fullname}</h5>
